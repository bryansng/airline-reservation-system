...
public class FlightController {
    ...
    public ResponseEntity<FlightsResponse> search(@RequestParam String departureAirport,
        ...
        Page<Flight> flights = (fromDepartureDate > 0)
                ? flightService.searchFromDate(departureAirport, arrivalAirport, departureDate.atStartOfDay(),
    ...
    public ResponseEntity<FlightsResponse> searchFromDate(@RequestParam String departureAirport,
        ...
        Page<Flight> flights = flightService.searchFromDate(departureAirport, arrivalAirport,
                departureDate.atStartOfDay(), numOfPassengers, pageNum);
        return new ResponseEntity<>(new FlightsResponse("Flights returned successfully.", flights.getContent()),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<FlightsResponse> searchByFlighName(@RequestParam String flightName,
    ...
    public ResponseEntity<GetFlightByIdResponse> getFlightById(@PathVariable("flightId") Long flightId) {
        ...
        return new ResponseEntity<>(new GetFlightByIdResponse("Flight retrieved successfully.", flightDTO),
                HttpStatus.FOUND);
    }
}
